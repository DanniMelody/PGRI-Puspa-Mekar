        ...
        <div className="grid gap-12 lg:grid-cols-4 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 flex gap-4">
              {/* WhatsApp */}
              <a href="https://wa.me/6285199297045" target="_blank" rel="noopener noreferrer" className="group flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-zinc-200 transition-all hover:-translate-y-1 hover:bg-emerald-500 hover:ring-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:outline-none" aria-label="Hubungi kami melalui WhatsApp">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/tkpgripuspamekar2026?igsh=Z2FkaW9neHFlYzA0" target="_blank" rel="noopener noreferrer" className="group flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-zinc-200 transition-all hover:-translate-y-1 hover:bg-rose-500 hover:ring-rose-500 focus-visible:ring-2 focus-visible:ring-rose-500 focus-visible:outline-none" aria-label="Ikuti kami di Instagram">
              ...
              {/* YouTube */}
              <a href="https://youtube.com/@tkpgripuspamekar8478?si=nlDIOCFHVdapz-id" target="_blank" rel="noopener noreferrer" className="group flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm ring-1 ring-zinc-200 transition-all hover:-translate-y-1 hover:bg-red-600 hover:ring-red-600 focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:outline-none" aria-label="Ikuti kami di YouTube">
                <svg className="h-6 w-6 text-red-600 transition-colors group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-4 text-base font-bold text-zinc-800">
              ...
              <Link href="/profil#legalitas" className="transition-colors hover:text-lime-600">Legalitas & Akreditasi</Link>
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-sm font-bold text-zinc-600">0851-9929-7045</p>
              </div>
              <div className="flex gap-3">
